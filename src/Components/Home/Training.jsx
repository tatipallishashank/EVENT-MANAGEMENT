        ...
        <Grid container spacing={2}>
          ...
          >
            <Paper elevation={2} className="training-item">
              ...
              <div className="box">
                <Typography variant="h3">In-time Course Completion</Typography>
                <Typography className="training-info">
                  Our events are strategically and innovatively designed,
                  blending both theoretical and practical teaching methods. The
                  modules are carefully chosen to ensure the event is as
                  industry-relevant as possible. The events are concise yet
            ...
            <Paper elevation={2} className="training-item">
              ...
              <div className="box">
                ...
                <Typography className="training-info">
                  ...
                  try the various programs and events that we offer through our
                  free demo service. Using this service students can test the
                  event quality and get a better understanding of what event
                  they want to study.
                </Typography>
              </div>
            </Paper>
